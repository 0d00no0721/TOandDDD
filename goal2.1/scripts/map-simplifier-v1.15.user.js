// ==UserScript==
// @name         Tanki Map Simplifier v1.15
// @namespace    https://github.com/0d00no0721/TOandDDD
// @version      1.15.0
// @description  Intercept texImage2D + createImageBitmap + Image.src + fetch + XHR. Custom image replacement (single image for all textures) with HSL fallback, hide billboards. Ctrl+Shift+M toggle.
