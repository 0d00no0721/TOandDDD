// ==UserScript==
// @name         Tanki Map Simplifier v1.15.2
// @namespace    https://github.com/0d00no0721/TOandDDD
// @version      1.15.2
// @description  Intercept texImage2D + createImageBitmap + Image.src + fetch + XHR. Custom image replacement (single image, baked alpha + opacity slider) with HSL fallback, hide billboards. Ctrl+Shift+M toggle.
